		...
		return (
			<div className="sidebarWrap">
				<Sidebar isOpen={this.state.sidebarOpen} onToggle={this.handleToggleSidebar}>
					<Sidebar.Item>item 0001</Sidebar.Item>
					<Sidebar.Item>item 0002</Sidebar.Item>
					<Sidebar.Item>item 0003</Sidebar.Item>
					<Sidebar.Item>item 0004</Sidebar.Item>
				</Sidebar>
				<div className={ `outerWrap ${this.state.sidebarOpen ? 'open' : ''}` }>
					...
					<Row>
						<Col md={10} lg={10} style={{background: '#f3f3f3'}}>
							...
							<p>
人色禮國心麼己黃帶。舉傷作點有破試說西定北相國地代少細四外笑受的到商，業學在題不企給只上洋，備供本入、作人靈爸沒不了做圖，成黨畫自？
